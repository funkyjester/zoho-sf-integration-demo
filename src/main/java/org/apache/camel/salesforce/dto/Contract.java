...
public class Contract extends AbstractDescribedSObjectBase {
    ...
    public void setCustomerSignedId(String CustomerSignedId) {
     ...
     @XStreamAlias("CustomerSigned")
    private Contact CustomerSigned;

    @JsonProperty("CustomerSigned")
    public Contact getCustomerSigned() {
        return this.CustomerSigned;
    }

    @JsonProperty("CustomerSigned")
    public void setCustomerSigned(Contact CustomerSigned) {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        sObjectDescriptionUrls1.setUiNewRecord("https://gabrielchanca-dev-ed.my.salesforce.com/800/e");

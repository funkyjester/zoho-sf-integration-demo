...
public class Account extends AbstractDescribedSObjectBase {
    ...
    private QueryRecordsContract Contracts;

    @JsonProperty("Contracts")
    public QueryRecordsContract getContracts() {
        return Contracts;
    }

    @JsonProperty("Contracts")
    public void setContracts(QueryRecordsContract Contracts) {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        final SObjectField sObjectField64 = createField("zohoId__c", "zohoId", "string", "xsd:string", 32, false, true, false, true, true, false, true);
        ...
        sObjectDescriptionUrls1.setUiNewRecord("https://gabrielchanca-dev-ed.my.salesforce.com/001/e");

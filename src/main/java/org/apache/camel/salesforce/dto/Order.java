...
public class Order extends AbstractDescribedSObjectBase {
    ...
    public void setCustomerAuthorizedById(String CustomerAuthorizedById) {
     ...
     @XStreamAlias("CustomerAuthorizedBy")
    private Contact CustomerAuthorizedBy;

    @JsonProperty("CustomerAuthorizedBy")
    public Contact getCustomerAuthorizedBy() {
        return this.CustomerAuthorizedBy;
    }

    @JsonProperty("CustomerAuthorizedBy")
    public void setCustomerAuthorizedBy(Contact CustomerAuthorizedBy) {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        sObjectDescriptionUrls1.setUiNewRecord("https://gabrielchanca-dev-ed.my.salesforce.com/801/e");
